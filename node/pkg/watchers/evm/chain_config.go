...
var (
	...
	mainnetChainConfig = EnvMap{
		...
		vaa.ChainIDMegaETH: {Finalized: true, Safe: true, EvmChainID: 4326, PublicRPC: "https://alpha.megaeth.com/rpc", ContractAddr: "0xaBf89de706B583424328B54dD05a8fC986750Da8"},
	}
	...
	testnetChainConfig = EnvMap{
		...
		vaa.ChainIDSepolia:         {Finalized: true, Safe: true, EvmChainID: 11155111, PublicRPC: "https://ethereum-sepolia-rpc.publicnode.com", ContractAddr: "0x3378932e90Dbf0724EDfd470F5b2eAD2333D89eb"},
		...
		vaa.ChainIDAuroria:         {Finalized: true, Safe: true, EvmChainID: 205205, PublicRPC: "https://auroria.rpc.xertra.com", ContractAddr: "0xc8C49f960e113E60276d5ff27bcc5fC1b8cB3626"},
	}
)
